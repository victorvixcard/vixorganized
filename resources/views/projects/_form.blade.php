...
<div>
    ...
    <input class="field" id="name" name="name" value="{{ old('name', $project->name ?? '') }}" required maxlength="120" autofocus>
</div>

<div>
    <label class="label" for="description">Descrição / objetivo</label>
...
<div class="grid gap-4 sm:grid-cols-3">
    ...
    <div>
        ...
        <input class="field" id="due_date" name="due_date" type="date" value="{{ old('due_date', isset($project) && $project->due_date ? $project->due_date->toDateString() : '') }}">
    </div>
</div>
